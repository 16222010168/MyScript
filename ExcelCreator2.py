...
class ExcelCreator():
    def __init__(self,sysname,acount,passwd,port,OS,privilege):
        self.sysname = sim_note
...
df = pd.read_excel('C:/Users/Charles/Desktop/常用表格/servers.xls',sheet_name='AllServers')
df2 = pd.read_excel('C:/Users/Charles/Desktop/常用表格/bk_cmdb_export_host.xlsx',sheet_name='host')
Iplist = df['IP地址']
sim_note = df['简要说明']
account = 'weblogic'
passwd = 'weblogic@2013'
port = '22'
OS = 'LINUX'
privilege = '否'
